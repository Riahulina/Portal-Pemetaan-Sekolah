...
<head>
    ...
    <title>Manajemen Pengguna - Admin SatuPeta</title>
        ...
        <main class="flex-1 flex flex-col min-h-screen overflow-y-auto">
            ...
            <header class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-30">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">Kelola data pengguna terdaftar</p>
                </div>
            ...
            <!-- CONTENT -->
            <div class="p-8 flex-1" x-data="userManager()" x-init="init()">
