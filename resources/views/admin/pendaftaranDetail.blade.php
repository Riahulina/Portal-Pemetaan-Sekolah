...
@section('content')
    <div x-data="{ rejectModal: false }">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div>
                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-orange-50 border border-orange-200 text-orange-700 text-xs font-bold shadow-sm">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div class="lg:col-span-2 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-y-4 gap-x-6 border-b border-gray-100 pb-5 mb-5">
                    ...
                    <div>
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Nama Sekolah</label>
                ...
                <div class="grid grid-cols-2 gap-y-4 gap-x-6 border-b border-gray-100 pb-5 mb-5 text-sm">
                    <div>
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider block mb-1">Jenjang</label>
                        <span class="inline-block px-2.5 py-0.5 text-xs font-bold rounded bg-teal-50 text-teal-600 border border-teal-200 uppercase">
                            {{ $sekolah->jenjang }}
                        </span>
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider block mb-1">Akreditasi</label>
                        <span class="inline-block px-2.5 py-0.5 text-xs font-bold rounded bg-amber-50 text-amber-600 border border-amber-200">
                            {{ $sekolah->akreditasi ?? 'B' }}
                        </span>
                    </div>
                    <div>
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider">No. Telepon</label>
                    ...
                    <div>
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Sosmed / Web</label>
                ...
                <div class="grid grid-cols-2 gap-y-4 gap-x-6 text-sm">
                    ...
                    <div>
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Kabupaten/Kota</label>
                    ...
                    <div>
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Longitude</label>
                        <p class="text-gray-800 font-medium mt-0.5">{{ $sekolah->longitude }}</p>
                        <span class="text-[9px] text-orange-500 font-medium block">Longitude Harus Format Standar Google Maps</span>
                    </div>
                    <div>
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Latitude</label>
                        <p class="text-gray-800 font-medium mt-0.5">{{ $sekolah->latitude }}</p>
                        <span class="text-[9px] text-orange-500 font-medium block">Latitude Harus Format Standar Google Maps</span>
                    </div>
                </div>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm sticky top-24">
                ...
                <div class="p-3 bg-sky-50 border border-sky-100 rounded-xl text-sky-800 text-xs leading-relaxed mb-6">
        ...
        <div x-show="rejectModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div x-show="rejectModal" x-transition
                ...
                <p class="text-xs text-gray-500 mb-4">Berikan alasan penolakan agar pendaftar dapat memperbaiki berkas atau data sekolah mereka.</p>
