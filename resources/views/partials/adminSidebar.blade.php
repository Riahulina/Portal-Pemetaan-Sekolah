        ...
        <nav class="flex flex-col gap-2 px-6 py-4 flex-1" style="font-family: 'Inter', sans-serif;">
            ...
            <a href="{{ route('admin.pendaftaran.index') }}"
                ...
                @if($pendingPendaftaran > 0)
                    <span class="bg-yellow-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">{{ $pendingPendaftaran }}</span>
                @endif
            </a>
            ...
            <a href="{{ route('admin.koreksi.index') }}"
                ...
                @if($pendingKoreksi > 0)
                    <span class="bg-yellow-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">{{ $pendingKoreksi }}</span>
                @endif
            </a>
