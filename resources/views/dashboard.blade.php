                ...
                <div id="right-sidebar">
                    <div id="table-component" class="w-full">
                        ...
                        <div class="sidebar-table__search-container">
                            <svg class="sidebar-table__search-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#9CA3AF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <circle cx="11" cy="11" r="8"/>
                                <line x1="21" y1="21" x2="16.65" y2="16.65"/>
                            </svg>
                            <input type="text" id="table-search" class="sidebar-table__search" placeholder="Cari nama sekolah..." />
                        </div>
                        ...
                        <div class="detail-panel__col detail-panel__col--left">
                            <div class="detail-panel__badges">
                                ...
                                <div class="detail-panel__students">
                                    <img src="{{ asset('assets/iconsiswa2.png') }}" alt="" class="detail-panel__student-icon">
                                    <span id="panel-murid">0</span>
                                </div>
                            </div>
                            <div class="detail-panel__address" id="panel-address">-</div>
                            <button id="btn-gmaps" class="btn-gmaps">
                                <img src="{{ asset('assets/icongooglemaps.png') }}" alt="" class="btn-gmaps__icon">
                                Buka di Google Maps
                            </button>
                            ...
                            <div class="detail-panel__social">
                                <a href="#" id="panel-ig" class="social-icon-link" target="_blank" rel="noopener">
                                    <img src="{{ asset('assets/iconig.png') }}" alt="Instagram">
                                </a>
                                <a href="#" id="panel-fb" class="social-icon-link" target="_blank" rel="noopener">
                                    <img src="{{ asset('assets/iconfb.png') }}" alt="Facebook">
                                </a>
                                <a href="#" id="panel-tiktok" class="social-icon-link" target="_blank" rel="noopener">
                        ...
                        <div class="detail-panel__col detail-panel__col--right">
                            <div class="detail-chart-container">
                                ...
                                <div class="detail-chart__legend" id="chart-legend">
                                    <div class="legend-row"><span class="legend-dot" style="background:#22C55E;"></span> Kelas 7 SMP - <strong>350</strong></div>
                                    <div class="legend-row"><span class="legend-dot" style="background:#F97316;"></span> Kelas 8 SMP - <strong>350</strong></div>
                                    <div class="legend-row"><span class="legend-dot" style="background:#3B82F6;"></span> Kelas 9 SMP - <strong>350</strong></div>
                                </div>
